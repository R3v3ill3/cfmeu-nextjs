...
// Custom header component for proper day distribution
  ...
  return (
    <div className="grid grid-cols-7 gap-1 mb-2">
      {daysOfWeek.map((day) => (
        <div
          key={day}
          className="text-center text-muted-foreground text-xs font-medium h-6 flex items-center justify-center"
        >
          {day}
        </div>
      ))}
    ...
    <div className={cn("p-3", className)}>
      ...
      <DayPicker
        ...
        classNames={{
          ...
          head_row: "hidden", // Hide default header since we use CustomHeader
          head_cell:
            "text-muted-foreground rounded-md w-9 font-normal text-[0.8rem] flex-1 text-center",
          row: "grid grid-cols-7 gap-1", // Use grid for proper 7-column layout
