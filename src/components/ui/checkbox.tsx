import { forwardRef, useRef, type ElementRef, type ComponentPropsWithoutRef } from 'react'
...
>(({ className, disabled, ...props }, ref) => {
  ...
  // Forward clicks from the touch target overlay to the checkbox
  ...
  return (
    <div className="relative inline-flex items-center justify-center">
      ...
      {/* Invisible touch target overlay for mobile only - forwards clicks to checkbox */}
      <div
