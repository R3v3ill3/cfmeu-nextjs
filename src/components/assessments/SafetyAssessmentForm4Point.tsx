...
import { CalendarIcon, Save, Eye, AlertCircle, CheckCircle, Shield } from "lucide-react"
...
interface SafetyAssessmentFormProps {
  ...
  employerName: string
  projectId?: string
  initialData?: Partial<SafetyAssessmentData>
  onSave?: (data: SafetyAssessmentData) => void
  onCancel?: () => void
  className?: string
}
...
const SAFETY_CRITERIA: RatingCriterion[] = [
  {
    id: "site_safety",
    name: "Site Safety",
    description: "Overall safety standards and practices on site",
    weight: 1.0
  },
  {
    id: "safety_procedures",
    name: "Safety Procedures",
    description: "Implementation and adherence to safety protocols",
    weight: 1.0
  },
  {
    id: "incident_reporting",
    name: "Incident Reporting",
    description: "Transparency and proper reporting of safety incidents",
    weight: 1.0
  }
]
...
export function SafetyAssessmentForm4Point({
  employerId,
  employerName,
  projectId,
  initialData,
  ...
  const [formData, setFormData] = useState<SafetyAssessmentData>({
  ...
  const handleSubmit = async (saveAsDraft = false) => {
    ...
    try {
      const response = await fetch("/api/assessments/safety-4-point-new", {
        method: "POST",
        headers: {
      ...
      toast({
        ...
        description: saveAsDraft
          ...
          : "Safety assessment submitted successfully",
      })
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm text-muted-foreground">Overall Safety Rating:</span>
            ...
            <div>
              <h4 className="font-medium mb-3">Safety Assessment Criteria</h4>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <Label className="text-base font-semibold">Safety Assessment Criteria</Label>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="bg-muted/30 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-sm text-muted-foreground">Current Overall Safety Rating</Label>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="notes"
              placeholder="Add any safety-related notes, observations, or concerns..."
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="follow_up_required">Safety follow up required</Label>
            </div>
