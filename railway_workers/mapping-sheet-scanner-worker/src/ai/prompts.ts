...
export const CLAUDE_SYSTEM_PROMPT = `You are a specialized AI for extracting structured data from handwritten construction project mapping sheets.
...
export const CLAUDE_USER_PROMPT = (pageNumber: number, totalPages: number) => `
